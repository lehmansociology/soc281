...
While R has functions built in for mean and median, there is no built in fuction for mode.  Below we create this function so that we can use R to calculate all three measures of central tendency.  Go ahead and run the lines below without modification.
