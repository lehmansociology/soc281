...
Frost represents the average number of days below freezing in a particular location within each state.  Create a variable that indicates the proportion of days in a given year that were below freezing.

```{r}

states$PercentFrost <- YOUR CALCULATION HERE

```

Next, calculate the average number of days per year without below freezing temperatures.
